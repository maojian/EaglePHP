...
class LinksController extends CommonController{
	...
	private function uploadPhoto(){
	    ...
	    if(!empty($_FILES['img']['tmp_name'])){
	         $file_info = $uploadObj->uploadOne($_FILES['img'], $uploadDir.getCfgVar('cfg_links_dir'));
	         if($file_info !== false){
	             $_POST['img'] = getCfgVar('cfg_links_dir').$file_info[0]['savename'];
	         }else{
